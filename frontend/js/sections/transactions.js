 ...
 */
 const transactionRenderer = ({currency}, transactions) => transactions && transactions.length ? transactions.reduce((transactionsHTML, { Value, Timestamp, Comment, ID }) =>  `${transactionsHTML}
